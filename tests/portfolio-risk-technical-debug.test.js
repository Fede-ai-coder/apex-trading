...
(function () {
  function buildMetricsCtx(env) {
    ...
    [
      ...
      '_portfolioQuantityFieldPresent', '_portfolioStrictQuantity', '_portfolioReadQuantityField', '_portfolioResidualQuantityFields', '_portfolioGrossQuantityFields', '_portfolioResolveLegQuantity', '_portfolioLegExplicitOpenQty', '_portfolioLegHasExplicitOpenQty',
      '_portfolioLegEffectiveQty', '_portfolioLegCloseMarkerFields', '_portfolioLegHasCloseMarker', '_isTerminalPortfolioLeg',

...
].sort(), 'production footprint is index.html, Journal Remote, and the module of every layer cut after it — the list above is the enumeration, so the message does not repeat it');

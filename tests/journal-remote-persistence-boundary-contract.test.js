...
same(changedProduction, [
 ...
 'js/services/journal-map-audit.js', 'js/services/dxlink-greeks-fetch.js', 'js/portfolio/portfolio-technical-parity.js', 'js/portfolio/portfolio-spy-price.js', 'js/services/apex-storage-recovery.js'].sort(), 'production footprint is index.html, Journal Remote, and the module of every layer cut after it — the list above is the enumeration, so the message does not repeat it');

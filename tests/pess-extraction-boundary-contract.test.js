...
eq(A.localSrcs[A.localSrcs.length - 11], './js/portfolio/backend-portfolios.js',
...
eq(A.localSrcs[A.localSrcs.length - 10], './js/portfolio/portfolio-expiry-manual.js',
...
eq(A.localSrcs[A.localSrcs.length - 9], './js/portfolio/portfolio-traffic-light.js',
...
eq(A.localSrcs[A.localSrcs.length - 8], './js/ui/backend-candle-store-chart.js',
...
eq(A.localSrcs[A.localSrcs.length - 7], './js/services/journal-rich-snapshot.js',
...
// slot is pinned by nothing unless a NEW final clause is added with it.
eq(A.localSrcs[A.localSrcs.length - 6], './js/portfolio/portfolio-backend-candles.js',
...
eq(A.localSrcs[A.localSrcs.length - 5], './js/services/journal-snapshot-prefetch.js',
...
// last slot is pinned by nothing unless a NEW final clause is added with it.
eq(A.localSrcs[A.localSrcs.length - 4], './js/portfolio/portfolio-dxlink-greeks.js',
...
eq(A.localSrcs[A.localSrcs.length - 3], './js/config/strategy-templates.js',
  '9.11z6 the strategy-templates owner is immediately before the vega-monitor owner');
// Re-terminated with the chain: bumping the indices alone would leave the last
// slot asserted by nothing at all.
eq(A.localSrcs[A.localSrcs.length - 2], './js/portfolio/portfolio-vega-monitor.js',
  '9.11z7 the vega-monitor owner is the newest local script before the monolith');
...
const GUARDS = [
  ...
  ['dsb-tail-preserved', (r) => r.localSrcs[r.localSrcs.length - 34] === './js/ui/backend-directional-snapshot-panel.js' &&
    r.localSrcs[r.localSrcs.length - 33] === './js/services/pretrade-risk-rules.js' &&
    r.localSrcs[r.localSrcs.length - 32] === './js/services/pretrade-technicals.js' &&
    r.localSrcs[r.localSrcs.length - 31] === './js/ui/pretrade-risk-modal.js' &&
    r.localSrcs[r.localSrcs.length - 30] === './js/services/mcx-market-context.js' &&
    r.localSrcs[r.localSrcs.length - 29] === './js/services/mcx-vix-market-context.js' &&
    r.localSrcs[r.localSrcs.length - 28] === './js/services/mcx-backend-candles.js' &&
    r.localSrcs[r.localSrcs.length - 27] === './js/services/journal-core.js' &&
    r.localSrcs[r.localSrcs.length - 26] === './js/services/mcx-regime-policy.js' &&
    r.localSrcs[r.localSrcs.length - 25] === './js/ui/journal-ui.js' &&
    r.localSrcs[r.localSrcs.length - 24] === './' + JOURNAL_REMOTE_REL &&
    r.localSrcs[r.localSrcs.length - 23] === './' + JOURNAL_WRITE_THROUGH_REL &&
    r.localSrcs[r.localSrcs.length - 22] === './' + JOURNAL_MIGRATION_REL &&
    r.localSrcs[r.localSrcs.length - 21] === './' + JOURNAL_MANUAL_IMPORT_REL &&
    r.localSrcs[r.localSrcs.length - 20] === './js/ui/journal-backup-restore.js' &&
    r.localSrcs[r.localSrcs.length - 19] === './js/ui/mcx-macro-check.js' &&
    r.localSrcs[r.localSrcs.length - 18] === './js/ui/mcx-charts.js' &&
    r.localSrcs[r.localSrcs.length - 17] === './js/services/apex-post-auth-init.js' &&
    r.localSrcs[r.localSrcs.length - 16] === './js/ui/tt-reconnect.js' &&
    r.localSrcs[r.localSrcs.length - 15] === './js/ui/journal-close-legs.js' &&
    r.localSrcs[r.localSrcs.length - 14] === './js/ui/journal-trade-forms.js' &&
    r.localSrcs[r.localSrcs.length - 13] === './js/ui/journal-trade-detail.js' &&
    r.localSrcs[r.localSrcs.length - 12] === './js/portfolio/portfolio-data-fetch.js' &&
    r.localSrcs[r.localSrcs.length - 11] === './js/portfolio/backend-portfolios.js' &&
    r.localSrcs[r.localSrcs.length - 10] === './js/portfolio/portfolio-expiry-manual.js' &&
    r.localSrcs[r.localSrcs.length - 9] === './js/portfolio/portfolio-traffic-light.js' &&
    ...
    r.localSrcs[r.localSrcs.length - 8] === './js/ui/backend-candle-store-chart.js' &&
    r.localSrcs[r.localSrcs.length - 7] === './js/services/journal-rich-snapshot.js' &&
    r.localSrcs[r.localSrcs.length - 6] === './js/portfolio/portfolio-backend-candles.js' &&
    r.localSrcs[r.localSrcs.length - 5] === './js/services/journal-snapshot-prefetch.js' &&
    r.localSrcs[r.localSrcs.length - 4] === './js/portfolio/portfolio-dxlink-greeks.js' &&
    r.localSrcs[r.localSrcs.length - 3] === './js/config/strategy-templates.js' &&
    r.localSrcs[r.localSrcs.length - 2] === './js/portfolio/portfolio-vega-monitor.js' &&
    r.localSrcs[r.localSrcs.length - 1] === './js/services/scanner-ivr-throttle.js'],

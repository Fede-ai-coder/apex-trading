...
eq(A.localSrcs[A.localSrcs.length - 8], './js/ui/backend-directional-snapshot-panel.js',
...
const GUARDS = [
  ...
  ['dsb-tail-preserved', (r) => r.localSrcs[r.localSrcs.length - 8] === './js/ui/backend-directional-snapshot-panel.js' &&

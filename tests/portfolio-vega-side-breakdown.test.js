...
function makeCtx() {
  ...
  [
    ...
    '_portfolioQuantityFieldPresent', '_portfolioStrictQuantity', '_portfolioReadQuantityField', '_portfolioResidualQuantityFields', '_portfolioGrossQuantityFields', '_portfolioResolveLegQuantity',
    '_portfolioLegExplicitOpenQty',
    '_portfolioLegHasExplicitOpenQty',
    '_portfolioLegEffectiveQty',
    '_portfolioLegCloseMarkerFields', '_portfolioLegHasCloseMarker',

...
eq(sha256(LIVE_INDEX), APEX_STORAGE_RECOVERY_U.EXTRACTED_SHA256,
...
eq(APP_LOADER.parseScriptTags(LIVE_INDEX).filter((entry) => entry.src && /^\.\//.test(entry.src)).length, APEX_STORAGE_RECOVERY_U.EXTRACTED_LOCAL_SCRIPTS,

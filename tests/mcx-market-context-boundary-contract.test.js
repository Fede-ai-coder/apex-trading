...
async function main() {
  ...
  same(changedProduction, ['index.html', MODULE_REL, VIX_MODULE_REL, BACKEND_CANDLES_REL, JOURNAL_CORE_REL, 'js/services/mcx-regime-policy.js', 'js/ui/journal-ui.js', JOURNAL_REMOTE_REL, JOURNAL_WRITE_THROUGH_REL, JOURNAL_MIGRATION_REL, JOURNAL_MANUAL_IMPORT_REL, 'js/ui/journal-backup-restore.js'].sort(), 'production footprint is exactly index.html + all four MCX owners + seven Journal owners');

...
const PRE_EXPIRY_MANUAL = EXPIRY_MANUAL_U.isApplied(PRE_TRAFFIC_LIGHT)
  ...
  : PRE_TRAFFIC_LIGHT;
const INDEX = BACKEND_PORTFOLIOS_U.isApplied(PRE_EXPIRY_MANUAL)
  ? BACKEND_PORTFOLIOS_U.undoBackendPortfolios(
      PRE_EXPIRY_MANUAL, fs.readFileSync(path.join(ROOT, 'js/portfolio/backend-portfolios.js'), 'utf8'))
  : PRE_EXPIRY_MANUAL;
...
eq(production,
  ['index.html', 'js/config/strategy-templates.js', 'js/portfolio/backend-portfolios.js', 'js/portfolio/portfolio-backend-candles.js', MODULE_REL,
   ...
   'js/portfolio/portfolio-vega-monitor.js', 'js/services/journal-map-audit.js', 'js/services/dxlink-greeks-fetch.js', 'js/portfolio/portfolio-technical-parity.js', 'js/portfolio/portfolio-spy-price.js', 'js/services/apex-storage-recovery.js',

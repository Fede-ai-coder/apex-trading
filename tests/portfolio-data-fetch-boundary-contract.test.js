...
// SEVEN layers were cut AFTER this one, so the live document is no longer the
...
eq(PARTS.findIndex((p) => !p.src), MODULE_POSITION + 12,
  '…and the inline monolith is twelve positions on');
{
...
eq(production,
  ['index.html', 'js/config/strategy-templates.js', 'js/portfolio/backend-portfolios.js', 'js/portfolio/portfolio-backend-candles.js', MODULE_REL,
   ...
   'js/services/scanner-ivr-throttle.js', 'js/ui/backend-candle-store-chart.js'],

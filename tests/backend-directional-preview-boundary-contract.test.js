...
(function () {
  ...
  eq(iJournalRemote, srcs.length - 2, 'ORDER: Journal Remote is the LAST external script before the inline monolith');
...
(function () {
  ...
  eq(journalRemoteTagIdx, inlineTagIdx - 1, 'tag order: Journal Remote is the LAST script tag before the inline monolith');

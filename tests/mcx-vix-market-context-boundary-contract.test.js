...
const richSnapshotOpen = '<script src="./js/services/journal-rich-snapshot.js">';
const richSnapshotTag = richSnapshotOpen + '</script>';
const afterRsAt = INDEX.indexOf('<script', INDEX.indexOf(richSnapshotTag) + richSnapshotTag.length);
const afterRsEnd = INDEX.indexOf('>', afterRsAt);
const afterRsTag = afterRsEnd >= 0 ? INDEX.slice(afterRsAt, afterRsEnd + 1) : '';
ok(INDEX.indexOf(candleChartTag) > INDEX.indexOf(trafficLightTag) && afterCcTag === richSnapshotOpen,
...
const dxlinkGreeksOpen = '<script src="./js/portfolio/portfolio-dxlink-greeks.js">';
const dxlinkGreeksTag = dxlinkGreeksOpen + '</script>';
const afterDgAt = INDEX.indexOf('<script', INDEX.indexOf(dxlinkGreeksTag) + dxlinkGreeksTag.length);
const afterDgEnd = INDEX.indexOf('>', afterDgAt);
...
const newestLayerTag = '<script src="./js/portfolio/portfolio-spy-price.js"></script>';
...
ok(INDEX.indexOf(newestLayerTag) > INDEX.indexOf(portfolioTechnicalParityTag)
  && INDEX.indexOf(portfolioTechnicalParityTag) > INDEX.indexOf(dxlinkGreeksFetchTag)
  && INDEX.indexOf(dxlinkGreeksFetchTag) > INDEX.indexOf(journalMapAuditTag)

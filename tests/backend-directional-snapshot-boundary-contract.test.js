...
const RICH_SNAPSHOT_EXTRACTION_SCRIPTS = [
...
eq(LOCAL_SCRIPTS.length + DECLARED_NON_DSB_SCRIPTS.length, 65,
...
eq(SIZE_CEILING, 35609, 'size ceiling = 1.5 × the largest shipped module, in owned declaration bytes');
{
  ...
  // The Journal trade-detail owner is a later, independently audited contiguous

...
expectOk(() => verifyLoad(SCRIPT_MODEL), '4.1 the script tag and its slot satisfy every load predicate');
{
  ...
  });
  {
    ...
    eq(slots[slots.length - 1] + 1, local.length - 31,
       '4.8g and the run ends immediately before the MCX macro-check owner');
  }
  eq(local[local.length - 31].src, './js/ui/mcx-macro-check.js',
  ...
  eq(local[local.length - 30].src, './js/ui/mcx-charts.js',
     '4.9c the MCX charts owner is immediately before the Apex shared post-auth owner');
  eq(local[local.length - 29].src, './js/services/apex-post-auth-init.js',
  ...
  eq(local[local.length - 28].src, './js/ui/tt-reconnect.js',
  ...
  eq(local[local.length - 27].src, './js/ui/journal-close-legs.js',
  ...
  eq(local[local.length - 26].src, './js/ui/journal-trade-forms.js',
  ...
  eq(local[local.length - 25].src, './js/ui/journal-trade-detail.js',
  ...
  eq(local[local.length - 24].src, './js/portfolio/portfolio-data-fetch.js',
  ...
  eq(local[local.length - 23].src, './js/portfolio/backend-portfolios.js',
  ...
  eq(local[local.length - 22].src, './js/portfolio/portfolio-expiry-manual.js',
  ...
  eq(local[local.length - 21].src, './js/portfolio/portfolio-traffic-light.js',
  ...
  eq(local[local.length - 20].src, './js/ui/backend-candle-store-chart.js',
  ...
  eq(local[local.length - 19].src, './js/services/journal-rich-snapshot.js',
  ...
  eq(local[local.length - 18].src, './js/portfolio/portfolio-backend-candles.js',
  ...
  eq(local[local.length - 17].src, './js/services/journal-snapshot-prefetch.js',
  ...
  eq(local[local.length - 16].src, './js/portfolio/portfolio-dxlink-greeks.js',
  ...
  eq(local[local.length - 15].src, './js/config/strategy-templates.js',
  ...
  eq(local[local.length - 14].src, './js/portfolio/portfolio-vega-monitor.js',
  ...
  eq(local[local.length - 13].src, './js/services/scanner-ivr-throttle.js',
  ...
  eq(local[local.length - 12].src, './js/services/scanner-earnings-throttle.js',
  ...
  eq(local[local.length - 11].src, './js/ui/chart-interactions.js',
  ...
  eq(local[local.length - 10].src, './js/services/journal-snapshot-helpers.js',
  ...
  eq(local[local.length - 9].src, './js/services/swing-weekly-candles.js',
  ...
  eq(local[local.length - 8].src, './js/services/swing-direction.js',
  ...
  eq(local[local.length - 7].src, './js/portfolio/backend-positions-aggregate.js',
     '4.9k37 the backend positions aggregate is immediately before the portfolio technical merge');
  // RE-TERMINATED ONCE MORE, in the file that gave this rule its name: the
  // clause above held the endpoint claim, and shifting alone would have left it
  // one place too high while the true endpoint went unasserted.
  eq(local[local.length - 6].src, './js/portfolio/portfolio-technical-merge.js',
     '4.9k39 the portfolio technical merge is immediately before the alignment debug pair');
  // RE-TERMINATED ONCE MORE, in the file that gave this rule its name: the
  // clause above held the endpoint claim, and shifting alone would have left it
  // one place too high while the true endpoint went unasserted.
  eq(local[local.length - 5].src, './js/portfolio/portfolio-technical-alignment-debug.js',
     '4.9k41 the alignment debug pair is immediately before the journal map-audit owner');
  // RE-TERMINATED ONCE MORE, in the file that gave this rule its name: the
  // clause above held the endpoint claim, and shifting alone would have left it
  // one place too high while the true endpoint went unasserted.
  eq(local[local.length - 4].src, './js/services/journal-map-audit.js',
  ...
  // clause above held the endpoint claim, and shifting alone would have left it
  // one place too high while the true endpoint went unasserted.
  eq(local[local.length - 3].src, './js/services/dxlink-greeks-fetch.js',
  ...
  // clause above held the endpoint claim, and shifting alone would have left it
  // one place too high while the true endpoint went unasserted.
  eq(local[local.length - 2].src, './js/portfolio/portfolio-technical-parity.js',
     '4.9k47 the technical-parity owner is the LAST local application script before the monolith');
  eq(local[local.length - 1].src, './js/portfolio/portfolio-spy-price.js',
     '4.9k the portfolio SPY price owner of #468 is the NEWEST local script, read off the tail\n'

...
expectOk(() => verifyLoad(SCRIPT_MODEL), '4.1 the script tag and its slot satisfy every load predicate');
{
  ...
  eq(local.length, 64,
     '4.9 index.html loads 64 local application scripts, including PRETRADE, all four MCX owners, seven Journal owners and the MCX macro-check, MCX charts, Apex post-auth, TT reconnect, Journal Close Legs, portfolio data-fetch, backend-portfolios, manual-expiry, traffic-light and candle-store-chart owners');
  eq(local[local.length - 12].src, './js/ui/mcx-macro-check.js',
  ...
  eq(local[local.length - 11].src, './js/ui/mcx-charts.js',
     '4.9c the MCX charts owner is immediately before the Apex shared post-auth owner');
  eq(local[local.length - 10].src, './js/services/apex-post-auth-init.js',
  ...
  eq(local[local.length - 9].src, './js/ui/tt-reconnect.js',
  ...
  eq(local[local.length - 8].src, './js/ui/journal-close-legs.js',
  ...
  eq(local[local.length - 7].src, './js/ui/journal-trade-forms.js',
  ...
  eq(local[local.length - 6].src, './js/ui/journal-trade-detail.js',
  ...
  eq(local[local.length - 5].src, './js/portfolio/portfolio-data-fetch.js',
  ...
  eq(local[local.length - 4].src, './js/portfolio/backend-portfolios.js',
  ...
  eq(local[local.length - 3].src, './js/portfolio/portfolio-expiry-manual.js',
  ...
  eq(local[local.length - 2].src, './js/portfolio/portfolio-traffic-light.js',
  ...
  eq(local[local.length - 1].src, './js/ui/backend-candle-store-chart.js',
     '4.9k12 the candle-store-chart owner is the LAST local application script before the inline monolith');

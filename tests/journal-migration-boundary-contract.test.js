...
const PRE_SWING_WEEKLY_CANDLES = SWING_WEEKLY_CANDLES_U.isApplied(INDEX)
  ? SWING_WEEKLY_CANDLES_U.undoSwingWeeklyCandles(
      INDEX, fs.readFileSync(path.join(ROOT, 'js/services/swing-weekly-candles.js'), 'utf8'))
  : INDEX;
...
eq(INDEX.length, 1520354, 'the live shipped index UTF-16 length is the newest layer’s extracted value');
eq(sha256(INDEX), '6f6e34aed9b095ba9a36ef3203d748d9d6b7abb84b2e811c1f41cc164537cc43',
